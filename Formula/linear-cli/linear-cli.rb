class LinearCli < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "d722ebd719cac94784ba5445b45969d74fba0335af81f7770cbc36a06251021e"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "026018ef3296858381d105aacafa400de8fa727088737f3e6e48f4df433a2b69"
    end

    on_arm do
      url "https://github.com/rubyists/linear-cli/releases/download/v#{version}/lc_linux_aarch64.tar.gz"
      sha256 "58be7602965aa22e37df20f668a36ee772a0342ae9a2fd872dfc3c11ae4191a3"
    end
  end
